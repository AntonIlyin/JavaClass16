...
Paper Towels 2.0 null false 0
   */
	...
	String category;
	 ...
	 StoreProduct(String storeLabel,double storePrice,String storeCategory,boolean storeHasExpiration,int storeStock){
		 label=storeLabel; 
		 price=storePrice;
		 category=storeCategory;
		 hasExpiration=storeHasExpiration;
		 stock=storeStock;
	 }
		 
		 StoreProduct(String storeLabel,double storePrice,String storeCategory, int storeStock){
			 label=storeLabel; 
			 price=storePrice;
			 category=storeCategory;
			 stock=storeStock;
	 }
		 StoreProduct(String storeLabel,double storePrice ){
			 label=storeLabel; 
			 price=storePrice;
...
public static void main(String[] args) {
	...
	StoreProduct obj1=new StoreProduct("Paper towels", 2.0,"misc",24);
